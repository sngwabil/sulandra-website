...
for(const relative of ['assets/spire-workspace-completion.css','assets/spire-workspace-completion.js','assets/spire-workspace-stability.js','assets/spire-workspace-polish.js','assets/spire-results-workspace.js']){
...
html=html.replace('</body>',`<script src="/assets/spire-workspace-completion.js?v=${version}"></script><script src="/assets/spire-workspace-stability.js?v=${version}"></script><script src="/assets/spire-workspace-polish.js?v=${version}"></script></body>`);
...
console.log('Final SPIRE static output pins complete workspaces, stability and selected-company UI polish after legacy clinical modules with no unfinished workspace copy.');
