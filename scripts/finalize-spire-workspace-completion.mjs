...
for(const relative of ['assets/spire-workspace-completion.css','assets/spire-workspace-completion.js','assets/spire-workspace-stability.js','assets/spire-results-workspace.js']){
...
html=html.replace('</body>',`<script src="/assets/spire-workspace-completion.js?v=${version}"></script><script src="/assets/spire-workspace-stability.js?v=${version}"></script></body>`);
