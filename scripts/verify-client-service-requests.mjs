...
const failures=[];
for(const file of ['service-request.html','service-request/index.html','assets/client-service-request-app.js','assets/admin-client-service-requests.js','assets/public-consultation-service-request-bridge.js']){
