...
for (const relative of [
  'employee-portal.html','employee-portal-railway.js','my-work.html','notifications.html','assets/sulandra-entity-context.js',
...
requireMarkers('Published Employee Portal', publishedPortal, [
  'employeeMyWorkLauncher','employeeNotificationsLauncher','employeeWorkCenterTitle','employeeNotificationHeaderCount','/my-work.html','/notifications.html',
]);
