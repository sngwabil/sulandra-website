...
need(data.console,files.console,['SPIRE_REVENUE_CLAIM_EXCHANGE_V1','No direct state submission is configured','X12 candidate generation','835 reconciliation','PNM/eMBS evidence workflows','/assets/revenue-claim-exchange-v1.js']);
need(data.runtime,files.runtime,['SPIRE_REVENUE_CLAIM_EXCHANGE_RUNTIME_V1','/api/revenue-cycle/exchange/status','/api/revenue-cycle/trading-profiles','/api/revenue-cycle/external-workflows','/api/revenue-cycle/x12-submissions','/x12-preview','/x12-submissions','/acknowledgements','/remittance-835','PNM_PROVIDER_ENROLLMENT','Authorization: `Bearer ${token()}`','response.blob()','URL.createObjectURL(blob)','Protected EDI candidate downloaded','No electronic submission occurred']);
