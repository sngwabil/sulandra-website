...
const head=`\n<!-- ${marker} -->\n<link rel="stylesheet" href="/assets/vendor/xterm.css?v=5.5.0">\n<link rel="stylesheet" href="/assets/it-agent-xterm-emulator.css?v=20260901-prod-14">\n`;
const body=`\n<!-- ${marker} -->\n<script src="/assets/vendor/sulandra-terminal-runtime.js?v=20260901-prod-14"></script>\n<script src="/assets/it-agent-terminal-wheel-scrollback.js?v=20260901-wheel-1"></script>\n<script src="/assets/it-agent-xterm-production-stack.js?v=20260901-prod-14"></script>\n<script src="/assets/it-agent-terminal-caret-clock.js?v=20260901-prod-14"></script>\n<script src="/assets/it-agent-terminal-caret-ui.js?v=20260901-prod-14"></script>\n`;
...
for(const target of targets){
  ...
  html=html.replace(/\n?<!-- IT_AGENT_XTERM_EMULATOR_PUBLICATION_V2 -->\n<script[^>]+sulandra-terminal-runtime\.js[^>]*><\/script>(?:\n<script[^>]+it-agent-terminal-wheel-scrollback\.js[^>]*><\/script>)?\n<script[^>]+it-agent-xterm-production-stack\.js[^>]*><\/script>(?:\n<script[^>]+it-agent-terminal-caret-clock\.js[^>]*><\/script>)?(?:\n<script[^>]+it-agent-terminal-caret-ui\.js[^>]*><\/script>)?\n?/g,'\n');
