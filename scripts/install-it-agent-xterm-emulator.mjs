...
const head=`\n<!-- ${marker} -->\n<link rel="stylesheet" href="/assets/vendor/xterm.css?v=6.0.0">\n<link rel="stylesheet" href="/assets/it-agent-xterm-emulator.css?v=20260830-prod-3">\n`;
const body=`\n<!-- ${marker} -->\n<script src="/assets/vendor/sulandra-terminal-runtime.js?v=20260830-prod-3"></script>\n<script src="/assets/it-agent-xterm-production-stack.js?v=20260830-prod-3"></script>\n`;
