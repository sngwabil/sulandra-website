...
const marker='IT_AGENT_XTERM_EMULATOR_PUBLICATION_V3';
...
for(const target of targets){
  ...
  html=html.replace(/\n?<!-- IT_AGENT_XTERM_EMULATOR_PUBLICATION_V[123] -->\n(?:<link[^>]+>\n?)+/g,'\n');
  html=html.replace(/\n?<!-- IT_AGENT_XTERM_EMULATOR_PUBLICATION_V[123] -->\n(?:<script[^>]+><\/script>\n?)+/g,'\n');
  ...
  console.log(`Published full xterm WSS runtime and persistent history viewer in ${path.relative(root,target)}.`);
}
