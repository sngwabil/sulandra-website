...
const [employeeLogin,adminLogin,spireLogin,spireLoginHtml,protectedSession,ssoInstaller,ssoRuntime]=await Promise.all([
  read('employee-login-railway.js'),
...
requireAll('Employee login protected session',employeeLogin,[
  '20260902-protected-session-2','armProtectedFullscreenFromGesture','enterProtectedSession',
...
forbidAll('S.P.I.R.E. native login',spireLogin,["/employee-login.html?returnTo=","portal: 'SPIRE' };"]);
...
requireAll('Static publication boundary',ssoInstaller,[
  ...
  'employeeAdminReturn','20260902-spire-native-login-2','employee-login-railway.js?v=20260902-protected-session-2',
