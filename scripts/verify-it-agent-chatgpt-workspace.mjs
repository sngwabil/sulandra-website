...
console.log('IT Agent chat-first workspace verified: owner-scoped conversation history, new-chat navigation, Action Center tab, inline file/image previews, and grounded live execution activity are wired without widening action permissions.');
