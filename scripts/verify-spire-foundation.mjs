...
has(data.marTimelineJs, ['SPIRE_MAR_TIMELINE_V1','Go to Now','Medication / Order','Completed / Inactive Medications','data-mar-filter="scheduled"','data-mar-filter="prn"'], 'SPIRE MAR timeline');
