...
expect(spirePreferences.includes("clientStation: { title:'#990000', toolbar:'#990000', background:'#eaf7fb'"),'SPIRE theme #21 is not the Client Station red/cyan/ice workstation palette');
