...
console.log('IT Agent chat-first workspace installed: persistent recent chats, New chat, left navigation, Action Center drawer, and inline attachment previews use the existing safe agent backend.');
