...
const resizeTag='<script src="/assets/it-agent-dock-resize.js?v=20260901-dock-resize-5"></script>';
...
for(const marker of ['SULANDRA_DOCK_RESIZE_CAPTURE_V5','setPointerCapture','pointerdown','pointermove','pointerup','itws-dock-resizing'])if(!resize.includes(marker))throw new Error(`Dock resize runtime missing ${marker}`);
