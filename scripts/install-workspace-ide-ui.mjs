...
const resizeTag='<script src="/assets/it-agent-dock-resize.js?v=20260901-dock-resize-2"></script>';
...
for(const marker of ['SULANDRA_DOCK_RESIZE_CAPTURE_V2','pointerdown','itws-dock-splitter','pointermove','itws-dock-resizing'])if(!resize.includes(marker))throw new Error(`Dock resize runtime missing ${marker}`);
