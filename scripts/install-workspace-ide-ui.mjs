...
const resizeTag='<script src="/assets/it-agent-dock-resize.js?v=20260901-dock-resize-1"></script>';
...
for(const marker of ['SULANDRA_DOCK_RESIZE_CAPTURE_V1','mousedown','itws-dock-splitter','mousemove','itws-dock-resizing'])if(!resize.includes(marker))throw new Error(`Dock resize runtime missing ${marker}`);
