...
const attendanceAssets = `<script src="/assets/time-attendance-blocked-attempts.js?v=20260805-gps-3"></script>\n<script src="/assets/time-attendance-geofence.js?v=20260805-gps-3"></script>`;
