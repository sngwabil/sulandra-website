...
const attendanceAssets = `<script src="/assets/time-attendance-blocked-attempts.js?v=20260805-gps-4"></script>\n<script src="/assets/time-attendance-geofence.js?v=20260805-gps-4"></script>`;
...
console.log('Time and Attendance routes, GPS geofencing, complete admin scheduling, blocked-attempt flags, manual punch review, and static portal navigation are installed.');
