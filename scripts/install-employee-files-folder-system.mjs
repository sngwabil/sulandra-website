...
if (!app.includes('EMPLOYEE_FILES_FOLDER_VIEW_V2')) {
...
console.log('Employee Files folder view installed using existing employee-scoped secure document storage; no backend schema or route mutation required.');
