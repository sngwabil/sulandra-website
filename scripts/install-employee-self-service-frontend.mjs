...
const version = '20260806-employee-communications-self-service-1';
...
try {
  ...
  console.log('Employee Portal approved records, compliance, workplace, performance, pay, leave, assets, access, documents, policies, e-signatures, workflow automation, assigned tasks, communications, announcements, notifications, feedback, and recognition installed.');
} catch (error) {
