...
const version = '20260806-employee-performance-self-service-1';
...
try {
  ...
  console.log('Employee Portal approved records, compliance, My Workplace, My Performance, goals, reviews, development plans, action plans, feedback, recognition, and notifications installed.');
} catch (error) {
