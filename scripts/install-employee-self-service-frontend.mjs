...
const version = '20260806-employee-health-safety-self-service-1';
...
try {
  ...
  console.log('Employee Portal approved records, compliance, workplace, performance, pay, leave, assets, access, documents, policies, e-signatures, workflow automation, assigned tasks, communications, announcements, notifications, engagement surveys, feedback, recognition, learning, training, development, health, safety, incident reporting, and wellness installed.');
} catch (error) {
