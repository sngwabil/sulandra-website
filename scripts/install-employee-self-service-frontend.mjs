...
const version = '20260806-employee-workflows-self-service-1';
...
try {
  ...
  console.log('Employee Portal approved records, compliance, workplace, performance, pay, leave, assets, access, documents, policies, e-signatures, workflow automation, assigned tasks, feedback, recognition, and notifications installed.');
} catch (error) {
