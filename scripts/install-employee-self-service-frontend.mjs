...
const version = '20260806-employee-leave-self-service-1';
...
try {
  ...
  console.log('Employee Portal approved records, compliance, My Workplace, My Performance, My Pay and Benefits, My Leave, payroll, benefits, goals, reviews, development plans, action plans, leave requests, feedback, recognition, and notifications installed.');
} catch (error) {
