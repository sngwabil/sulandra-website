...
const version = '20260806-employee-compensation-self-service-1';
...
try {
  ...
  console.log('Employee Portal approved records, compliance, My Workplace, My Performance, My Pay and Benefits, goals, reviews, development plans, action plans, payroll, benefits, statements, feedback, recognition, and notifications installed.');
} catch (error) {
