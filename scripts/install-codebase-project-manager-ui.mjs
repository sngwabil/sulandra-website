...
if (tagIndex < 0 || guardIndex <= tagIndex || manageIndex <= guardIndex || durabilityIndex <= manageIndex || bodyIndex <= durabilityIndex) {
...
console.log(`Published Codebase project manager, removal guard, and Manage tab before terminal durability runtime in ${target}`);
