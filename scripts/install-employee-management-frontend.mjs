...
html = html
  ...
  .replace(/\s*<script src="\/assets\/admin-employee-assets-access\.js(?:\?v=[^"']+)?"><\/script>\s*/g, '\n')
  ...
  .replace(/\s*<script src="\/assets\/admin-employee-engagement\.js(?:\?v=[^"']+)?"><\/script>\s*/g, '\n')
  .replace(/\s*<script src="\/assets\/admin-employee-learning\.js(?:\?v=[^"']+)?"><\/script>\s*/g, '\n')
  .replace(/\s*<script src="\/assets\/admin-employee-health-safety\.js(?:\?v=[^"']+)?"><\/script>\s*/g, '\n')
  .replace(/\s*<script src="\/assets\/admin-employee360-enterprise-controls\.js(?:\?v=[^"']+)?"><\/script>\s*/g, '\n');
