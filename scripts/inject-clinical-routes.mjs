...
const imports = [
  ...
  "import { registerSpireEvvRevenueGate } from './spire-evv-revenue-gate.js';",
  ...
  "import { registerSpireOhioIspLifecycleGuard } from './spire-ohio-isp-lifecycle-guard.js';",
  "import { registerSpireCarePlanLifecycleRoutes } from './spire-care-plan-lifecycle-routes.js';",
  "import { registerSpireOhioIspRoutes } from './spire-ohio-isp-routes.js';",
  "import { registerSpireOhioIspRepositoryRoutes } from './spire-ohio-isp-repository-routes.js';",
  ...
  "import { registerSpireEvvAdapterRoutes } from './spire-evv-adapter-routes.js';",
  "import { registerSpireAuthorizationsEvvRoutes } from './spire-authorizations-evv-routes.js';",
  "import { registerSpireDoddServiceDocumentationRoutes } from './spire-dodd-service-documentation-routes.js';",
  "import { registerSpireDocumentsExternalRecordsRoutes } from './spire-documents-external-records-routes.js';",
  "import { registerSpireProfileImageRoutes } from './spire-profile-image-routes.js';",
...
const calls = [
  ...
  'registerSpireOhioIspLifecycleGuard(app, prisma, { authOf });',
  ...
  'registerSpireProfileImageRoutes(app, prisma, { authOf });',
...
console.log(`Registered the complete SPIRE enterprise, transactional File, continuous flowsheet and field-mobile route set in ${target}.`);
