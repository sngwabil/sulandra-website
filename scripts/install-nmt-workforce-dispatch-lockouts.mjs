...
console.log('DODD NMT workforce and dispatch lockouts installed: every assigned driver is checked server-side for active verified qualification evidence before trip creation.');
